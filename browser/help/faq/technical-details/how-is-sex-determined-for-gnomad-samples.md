---
question: 'How is sex determined for OurDNA samples?'
---

We used normalized coverage across the X and Y chromosomes to assign sex for each OurDNA sample.The normalized coverage was computed as the mean coverage on sex chromosomes / mean coverage on chromosome 20. The metrics and thresholds used for sex assignment were as follows:
