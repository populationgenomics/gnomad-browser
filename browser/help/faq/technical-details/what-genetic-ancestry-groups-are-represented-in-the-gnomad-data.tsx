      ...
      <div>
        ...
        <TableWrapper>
          <SampleCountTable>
            ...
            <tbody>
              {['afr', 'ami', 'amr', 'asj', 'eas', 'fin', 'mid', 'nfe', 'sas', 'oth'].map(
                (popId) => (
                  <tr key={popId}>
                    ...
                    <td>
                      {(sampleCounts.gnomad_r3_non_cancer.genomes[popId] || 0).toLocaleString()}
                    </td>
                    <td>
                      {(sampleCounts.gnomad_r3_non_neuro.genomes[popId] || 0).toLocaleString()}
                    </td>
                    <td>
                      {(sampleCounts.gnomad_r3_non_topmed.genomes[popId] || 0).toLocaleString()}
                    </td>
            ...
            <tfoot>
              <tr>
                ...
                <td>
                  {sampleCounts.gnomad_r3_controls_and_biobanks.genomesTotal.toLocaleString()}
                </td>
            ...
            <tbody>
              {['afr', 'ami', 'amr', 'asj', 'eas', 'fin', 'nfe', 'sas', 'oth'].map((popId) => (
                <tr key={popId}>
                  ...
                  <td>
                    {(sampleCounts.gnomad_r2_1_non_cancer.exomes[popId] || 0).toLocaleString()}
                  </td>
                  <td>
                    {popId === 'sas'
                      ? '*'
                  ...
                  <td>
                    {(sampleCounts.gnomad_r2_1_non_neuro.exomes[popId] || 0).toLocaleString()}
                  </td>
                  <td>
                    {popId === 'sas'
                      ? '*'
                  ...
                  <td>
                    {(sampleCounts.gnomad_r2_1_non_topmed.exomes[popId] || 0).toLocaleString()}
                  </td>
                  <td>
                    {popId === 'sas'
                      ? '*'
