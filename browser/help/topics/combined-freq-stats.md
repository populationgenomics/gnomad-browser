...
Note that the statistical tests and associated discrepant frequency flag added in OurDNA v4.1 are a minimum viable product (MVP) version. We encourage feedback on this flag and note that users should exercise caution when using these results for interpretation, as they are preliminary and subject to revisions in future updates.
