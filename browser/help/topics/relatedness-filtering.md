...
Relatedness filtering for the v4 release was done using [cuKING](https://github.com/populationgenomics/cuKING/tree/1d29d72a184da33cf2500f8b537ae56ce66a7e96). Relatedness was computed amongst all samples that passed our hard filters (both exomes and genomes in OurDNA v4) together. We used 1.1 million autosomal SNVs with an allele frequency > 0.01% and a call rate of > 95% in the combined OurDNA v3.1.2 and CCDG genome data, a call rate > 99% in both CCDG and UKBB exome data and LD-pruned with a cutoff of r<sup>2</sup> = 0.1 for inferring relatedness.
...
- Genomes had priority over exomes in OurDNA v4.1
- Within genomes
