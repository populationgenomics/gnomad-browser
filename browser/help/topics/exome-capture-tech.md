...
The OurDNA database is composed of samples that have been sequenced over the last two decades at the Broad Institute. During that time, hybrid selection, capture, and sequencing machines and technologies have all changed, resulting in 20 imputed sequencing platforms within the v4 exome dataset. 

![visualization of platform imputation](exome-capture-tech.png)
*PCA visualization of platform imputation, i.e. the sequencing technologies and software suites used in the OurDNA v4 exome dataset.*
